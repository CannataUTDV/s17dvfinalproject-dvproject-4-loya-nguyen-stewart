...
sessionInfo()
source('../03 Visualizations/project5Plots.R')
...
1. Copy and paste the following link into your prefered web browser: https://data.world/robin-stewart/s-17-dv-project-5
...
Lastly, all the R visualizations were put on the same png file using the grid R package:

![Joint Crosstabs Plots](../03 Visualizations/crossTabPlots.png)
...
Here is a link to the published shiny application: https://carlosloya.shinyapps.io/fatalpoliceshootingsandcensusdata/
